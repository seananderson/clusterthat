---
title: "Fisheries ensemble self-organized map: Icelandic cod"
...
Next we create the size of the SOM training grid. The dimensions are chosen aiming for 5-10 units per class. In this case we chose 6 classes to cover 49 stock assessment model runs.
