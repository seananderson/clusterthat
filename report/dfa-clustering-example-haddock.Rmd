---
title: "Dynamic Factor Analysis ensemble clustering for haddock"
---
...
haddock_ts$ssb[haddock_ts$ssb > 3e5] <- 3e5
ggplot(haddock_ts) + geom_line(aes(
  x = year, y = ssb,
  colour = model_id, group = model_id
)) +
...
```{r}
look_up <- data.frame(model_id = unique(haddock_ts$model_id),
