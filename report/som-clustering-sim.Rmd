---
title: "Fisheries ensemble self-organized map: Simulation"
...
Next we create the size of the SOM training grid. The dimensions are chosen aiming for 5-10 units per class. In this case we chose 6 classes to cover 54 simulated stock assessment model runs.
...
In this case, the PAM algorithm recommends six clusters. As an example, we can look at how the six classes would separate into two clusters:
