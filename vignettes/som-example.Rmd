...
In this case, while six clusters has the highest silhoutte width, we demonstrate the hierarchical clustering with three clusters since the average silhouette widths are relatively close. 
